...
export default function RecurringInvoicesPage() {
  ...
  const createProfileMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setShowModal(false);
      setFormData({ profileName: "", customerName: "", amount: "", frequency: "Monthly", startDate: new Date().toISOString().split("T")[0] });
        ...
        <div className="p-6 max-w-6xl mx-auto space-y-6">
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-3 bg-gray-50/50">
              ...
              <div>
                <h2 className="font-semibold text-gray-800">Automated Invoice Schedules</h2>
                <p className="text-xs text-gray-500">Automatically generate and dispatch recurring invoices according to your schedule.</p>
              </div>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-sm text-gray-500 max-w-md mx-auto mb-5">
                  Set up repeating customer invoices on weekly, monthly, or quarterly schedules to automate regular retainer and subscription billing.
                </p>
                <button
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden">
            <div className="px-6 py-4 border-b bg-gray-50 flex justify-between items-center">
              <h3 className="font-semibold text-gray-800">Create Recurring Invoice</h3>
